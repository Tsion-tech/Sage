  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        name="Documents"
        component={Documents}
        options={{ tabBarIcon: ({ color, size }) => <MaterialIcons name="description" size={size} color={color} /> }}
      />
      <Tab.Screen
        name="Appointments"
        component={Appointments}
        options={{ tabBarIcon: ({ color, size }) => <MaterialIcons name="event" size={size} color={color} /> }}
      />
      <Tab.Screen
        name="Settings"
        component={Settings}
