...
mongoose.connect("mongodb+srv://Tsiony:tsion07@cluster0.huwneam.mongodb.net/Shoes?retryWrites=true&w=majority&appName=Cluster0")
...
function auth(req, res, next) {
    ...
    jwt.verify(token, "tsiony", (err, decoded) => {
